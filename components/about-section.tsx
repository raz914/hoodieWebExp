...
export default function AboutSection() {
  ...
  return (
    ...
    >
      <div ref={ref} className="max-w-[1600px] mx-auto px-4 sm:px-6 md:px-8 flex flex-col items-center text-white">
        <motion.h2
          className="text-2xl sm:text-3xl md:text-4xl font-bold text-center mb-6 sm:mb-8 md:mb-10 text-white"
        ...
        <motion.div
          className="prose prose-sm sm:prose-base md:prose-lg max-w-none text-white prose-headings:text-white prose-p:text-white"
          initial={{ opacity: 0, y: 20 }}
          animate={isInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 20 }}
          transition={{ duration: 0.5, delay: 0.2 }}
          style={{ color: 'white' }}
        >
          <p className="text-white text-sm sm:text-base md:text-lg mb-4 text-overflow-fix" style={{ color: 'white' }}>
          ...
          <p className="text-white text-sm sm:text-base md:text-lg text-overflow-fix" style={{ color: 'white' }}>
